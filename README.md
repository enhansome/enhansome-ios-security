...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,303 | 🐛 1,912 | 🌐 Java | 📅 2026-08-10 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,561 | 🐛 823 | 🌐 C | 📅 2026-08-12 - UNIX-like reverse engineering framework and command-line toolset.
...
* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,904 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 - A tool to pull a decrypted IPA from a jailbroken device.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,483 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
...
* [bfdecrypt](https://github.com/BishopFox/bfdecrypt) ⭐ 486 | 🐛 10 | 🌐 C | 📅 2020-05-24 - Utility to decrypt App Store apps on jailbroken iOS 11.x.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,150 | 🐛 57 | 🌐 Python | 📅 2026-08-12 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 958 | 🐛 4 | 🌐 C++ | 📅 2026-08-12 - A Mach-O viewer for Windows, Linux and macOS.
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,313 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,124 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,064 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [Grapefruit](https://github.com/ChiChou/grapefruit) ⭐ 1,372 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-11 - Runtime Application Instruments for iOS.
* [Dwarf](https://github.com/iGio90/Dwarf) ⭐ 1,317 | 🐛 5 | 🌐 Python | 📅 2024-05-16 - Full featured multi arch/os debugger built on top of PyQt5 and frida.
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,002 | 🐛 206 | 🌐 C | 📅 2026-08-12 - Cross-platform instrumentation and introspection library written in C.
...
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 539 | 🐛 8 | 🌐 C++ | 📅 2026-08-08 - An integration of the Ghidra decompiler for radare2.
...
* [OWASP Mobile Application Security Verification Standard (MASVS)](https://github.com/OWASP/owasp-masvs) ⭐ 2,426 | 🐛 3 | 🌐 Python | 📅 2025-12-22
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,108 | 🐛 227 | 🌐 Python | 📅 2026-08-03
...
* [theos](https://github.com/theos/theos) ⭐ 4,902 | 🐛 73 | 🌐 Makefile | 📅 2026-08-08 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
