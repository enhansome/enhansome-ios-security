...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,410 | 🐛 1,912 | 🌐 Java | 📅 2026-08-13 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,582 | 🐛 819 | 🌐 C | 📅 2026-08-16 - UNIX-like reverse engineering framework and command-line toolset.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,486 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
* [dsdump](https://github.com/DerekSelander/dsdump) ⚠️ Archived - An improved nm + objc/swift class-dump tool.
* [flexdecrypt](https://github.com/JohnCoates/flexdecrypt) ⭐ 737 | 🐛 8 | 🌐 Swift | 📅 2023-06-24 - An iOS App & Mach-O binary decryptor.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,151 | 🐛 60 | 🌐 Python | 📅 2026-08-16 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 960 | 🐛 4 | 🌐 C++ | 📅 2026-08-16 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,640 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,319 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,062 | 🐛 123 | 🌐 Python | 📅 2026-07-22 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,136 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,069 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,432 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-12 - Radare2 and Frida better together.
...
* [iOS CheatSheet](https://github.com/randorisec/MobileHackingCheatSheet/blob/master/LEGACY.md#ios-cheatsheet) ⭐ 1,683 | 🐛 2 | 📅 2026-03-19
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,117 | 🐛 230 | 🌐 Python | 📅 2026-08-14
...
* [theos](https://github.com/theos/theos) ⭐ 4,905 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
