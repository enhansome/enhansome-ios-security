...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 78,391 | 🐛 1,962 | 🌐 Java | 📅 2026-09-17 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,820 | 🐛 822 | 🌐 C | 📅 2026-09-16 - UNIX-like reverse engineering framework and command-line toolset.
...
* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,929 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 - A tool to pull a decrypted IPA from a jailbroken device.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,502 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,281 | 🐛 64 | 🌐 Python | 📅 2026-09-17 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-17 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,955 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,394 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,100 | 🐛 110 | 🌐 Python | 📅 2026-09-13 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,215 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-16 - Radare2 and Frida better together.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,019 | 🐛 209 | 🌐 C | 📅 2026-09-16 - Cross-platform instrumentation and introspection library written in C.
...
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 550 | 🐛 5 | 🌐 C++ | 📅 2026-09-16 - An integration of the Ghidra decompiler for radare2.
...
* [SSL Kill Switch 2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,315 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 - A blackbox tool to disable SSL/TLS certificate validation - including certificate pinning - within iOS and macOS applications.
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,184 | 🐛 236 | 🌐 Python | 📅 2026-09-17
...
* [theos](https://github.com/theos/theos) ⭐ 4,918 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
