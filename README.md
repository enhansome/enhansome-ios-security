...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,658 | 🐛 1,955 | 🌐 Java | 📅 2026-09-25 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,871 | 🐛 819 | 🌐 C | 📅 2026-09-25 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,815 | 🐛 495 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,302 | 🐛 57 | 🌐 Python | 📅 2026-09-25 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-25 - A Mach-O viewer for Windows, Linux and macOS.
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,406 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,110 | 🐛 114 | 🌐 Python | 📅 2026-09-24 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,228 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,092 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,443 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-25 - Radare2 and Frida better together.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,022 | 🐛 202 | 🌐 C | 📅 2026-09-25 - Cross-platform instrumentation and introspection library written in C.
* [iproxy](https://github.com/libimobiledevice/libusbmuxd) ⭐ 689 | 🐛 31 | 🌐 C | 📅 2025-09-07 - A utility allows binding local TCP ports so that a connection to one (or more) of the local ports will be forwarded to the specified port (or ports) on a usbmux device.
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 553 | 🐛 3 | 🌐 C++ | 📅 2026-09-22 - An integration of the Ghidra decompiler for radare2.
...
* [iOS CheatSheet](https://github.com/randorisec/MobileHackingCheatSheet/blob/master/LEGACY.md#ios-cheatsheet) ⭐ 1,693 | 🐛 2 | 📅 2026-03-19
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,204 | 🐛 243 | 🌐 Python | 📅 2026-09-20
