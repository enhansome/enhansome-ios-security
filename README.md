...
[<img src="https://upload.wikimedia.org/wikipedia/commons/5/56/IOS_15_logo.png" align="right" width="70" alt="iOS 15">](https://github.com/Cy-clon3/awesome-ios-security/) ⭐ 670 | 🐛 4 | 📅 2024-01-05
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,784 | 🐛 1,919 | 🌐 Java | 📅 2026-08-25 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,643 | 🐛 820 | 🌐 C | 📅 2026-08-25 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,569 | 🐛 493 | 🌐 C++ | 📅 2026-08-22 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,920 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 - A tool to pull a decrypted IPA from a jailbroken device.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,494 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
...
* [bfdecrypt](https://github.com/BishopFox/bfdecrypt) ⭐ 490 | 🐛 10 | 🌐 C | 📅 2020-05-24 - Utility to decrypt App Store apps on jailbroken iOS 11.x.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,170 | 🐛 61 | 🌐 Python | 📅 2026-08-25 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 960 | 🐛 4 | 🌐 C++ | 📅 2026-08-24 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,736 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,345 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,073 | 🐛 123 | 🌐 Python | 📅 2026-07-22 - An advanced binary emulation framework.
* [fishhook](https://github.com/facebook/fishhook) ⭐ 5,425 | 🐛 39 | 🌐 C | 📅 2024-08-01 - A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,163 | 🐛 419 | 🌐 Java | 📅 2026-08-25 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,074 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,008 | 🐛 207 | 🌐 C | 📅 2026-08-22 - Cross-platform instrumentation and introspection library written in C.
...
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 540 | 🐛 5 | 🌐 C++ | 📅 2026-08-23 - An integration of the Ghidra decompiler for radare2.
...
* [SSL Kill Switch 2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,310 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 - A blackbox tool to disable SSL/TLS certificate validation - including certificate pinning - within iOS and macOS applications.
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,134 | 🐛 233 | 🌐 Python | 📅 2026-08-14
...
* [theos](https://github.com/theos/theos) ⭐ 4,910 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
