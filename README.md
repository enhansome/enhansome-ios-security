...
[<img src="https://upload.wikimedia.org/wikipedia/commons/5/56/IOS_15_logo.png" align="right" width="70" alt="iOS 15">](https://github.com/Cy-clon3/awesome-ios-security/) ⭐ 673 | 🐛 5 | 📅 2024-01-05
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,016 | 🐛 1,962 | 🌐 Java | 📅 2026-09-18 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,828 | 🐛 833 | 🌐 C | 📅 2026-09-18 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,744 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
* [iOS App Signer](https://github.com/DanTheMan827/ios-app-signer) ⭐ 6,318 | 🐛 123 | 🌐 Objective-C | 📅 2026-09-17 - An app for macOS that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,928 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 - A tool to pull a decrypted IPA from a jailbroken device.
* [Clutch](https://github.com/KJCracks/Clutch) ⭐ 3,823 | 🐛 43 | 🌐 Objective-C | 📅 2024-11-15 - A high-speed iOS decryption tool.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,503 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
* [dsdump](https://github.com/DerekSelander/dsdump) ⚠️ Archived - An improved nm + objc/swift class-dump tool.
* [flexdecrypt](https://github.com/JohnCoates/flexdecrypt) ⭐ 739 | 🐛 8 | 🌐 Swift | 📅 2023-06-24 - An iOS App & Mach-O binary decryptor.
* [bfinject](https://github.com/BishopFox/bfinject) ⭐ 643 | 🐛 34 | 🌐 Objective-C++ | 📅 2022-03-17 - Easy dylib injection for jailbroken 64-bit iOS 11.0 - 11.1.2. Compatible with Electra and LiberiOS jailbreaks.
* [bfdecrypt](https://github.com/BishopFox/bfdecrypt) ⭐ 492 | 🐛 10 | 🌐 C | 📅 2020-05-24 - Utility to decrypt App Store apps on jailbroken iOS 11.x.
* [SwiftDump](https://github.com/neil-wu/SwiftDump/) ⭐ 440 | 🐛 6 | 🌐 Swift | 📅 2023-08-18 - A command-line tool for retriving the Swift Object info from Mach-O file.
* [r2flutch](https://github.com/as0ler/r2flutch) ⭐ 184 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Yet another tool to decrypt iOS apps using r2frida.
...
* [Keychain Dumper](https://github.com/ptoomey3/Keychain-Dumper) ⭐ 1,423 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15 - A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken.
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,290 | 🐛 61 | 🌐 Python | 📅 2026-09-19 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-19 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,975 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,401 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,103 | 🐛 111 | 🌐 Python | 📅 2026-09-13 - An advanced binary emulation framework.
* [fishhook](https://github.com/facebook/fishhook) ⭐ 5,431 | 🐛 39 | 🌐 C | 📅 2024-08-01 - A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,219 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
* [ios-deploy](https://github.com/ios-control/ios-deploy) ⭐ 3,635 | 🐛 45 | 🌐 Objective-C | 📅 2024-06-24 - Install and debug iOS apps from the command line. Designed to work on un-jailbroken devices.
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,090 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [Grapefruit](https://github.com/ChiChou/grapefruit) ⭐ 1,390 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-11 - Runtime Application Instruments for iOS.
* [Dwarf](https://github.com/iGio90/Dwarf) ⭐ 1,319 | 🐛 5 | 🌐 Python | 📅 2024-05-16 - Full featured multi arch/os debugger built on top of PyQt5 and frida.
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,019 | 🐛 210 | 🌐 C | 📅 2026-09-16 - Cross-platform instrumentation and introspection library written in C.
* [iproxy](https://github.com/libimobiledevice/libusbmuxd) ⭐ 688 | 🐛 31 | 🌐 C | 📅 2025-09-07 - A utility allows binding local TCP ports so that a connection to one (or more) of the local ports will be forwarded to the specified port (or ports) on a usbmux device.
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 551 | 🐛 5 | 🌐 C++ | 📅 2026-09-16 - An integration of the Ghidra decompiler for radare2.
...
* [SSL Kill Switch 2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,317 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 - A blackbox tool to disable SSL/TLS certificate validation - including certificate pinning - within iOS and macOS applications.
* [SSLBypass](https://github.com/evilpenguin/SSLBypass) ⭐ 265 | 🐛 1 | 🌐 Objective-C++ | 📅 2021-10-13 - An iOS SSL Pinning Bypass Tweak (iOS 8 - 14).
...
* [iOS CheatSheet](https://github.com/randorisec/MobileHackingCheatSheet/blob/master/LEGACY.md#ios-cheatsheet) ⭐ 1,689 | 🐛 2 | 📅 2026-03-19
...
* [Myriam](https://github.com/GeoSn0w/Myriam) ⭐ 270 | 🐛 4 | 📅 2026-05-21
* [WaTF Bank](https://github.com/WaTF-Team/WaTF-Bank) ⭐ 146 | 🐛 2 | 🌐 C | 📅 2021-11-24
* [Damn Vulnerable iOS Application (DVIA)](https://damnvulnerableiosapp.com/)
* [OWASP iGoat](https://igoatapp.com/)

## CTF

* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,187 | 🐛 239 | 🌐 Python | 📅 2026-09-18
...
* [theos](https://github.com/theos/theos) ⭐ 4,918 | 🐛 72 | 🌐 Makefile | 📅 2026-09-18 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
