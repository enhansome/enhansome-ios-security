...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,577 | 🐛 1,914 | 🌐 Java | 📅 2026-08-20 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,608 | 🐛 821 | 🌐 C | 📅 2026-08-20 - UNIX-like reverse engineering framework and command-line toolset.
...
* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,917 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 - A tool to pull a decrypted IPA from a jailbroken device.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,489 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
...
* [r2flutch](https://github.com/as0ler/r2flutch) ⭐ 184 | 🐛 0 | 🌐 Python | 📅 2026-04-16 - Yet another tool to decrypt iOS apps using r2frida.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,161 | 🐛 62 | 🌐 Python | 📅 2026-08-20 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 960 | 🐛 4 | 🌐 C++ | 📅 2026-08-20 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,684 | 🐛 1,958 | 🌐 Meson | 📅 2026-08-18 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,330 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,063 | 🐛 123 | 🌐 Python | 📅 2026-07-22 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,147 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,072 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,434 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-12 - Radare2 and Frida better together.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,005 | 🐛 206 | 🌐 C | 📅 2026-08-20 - Cross-platform instrumentation and introspection library written in C.
* [iproxy](https://github.com/libimobiledevice/libusbmuxd) ⭐ 685 | 🐛 31 | 🌐 C | 📅 2025-09-07 - A utility allows binding local TCP ports so that a connection to one (or more) of the local ports will be forwarded to the specified port (or ports) on a usbmux device.
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,123 | 🐛 233 | 🌐 Python | 📅 2026-08-14
...
* [theos](https://github.com/theos/theos) ⭐ 4,909 | 🐛 75 | 🌐 Makefile | 📅 2026-08-08 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
