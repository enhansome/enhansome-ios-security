...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,721 | 🐛 1,960 | 🌐 Java | 📅 2026-09-25 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,878 | 🐛 814 | 🌐 C | 📅 2026-09-26 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,823 | 🐛 495 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [bfinject](https://github.com/BishopFox/bfinject) ⭐ 644 | 🐛 34 | 🌐 Objective-C++ | 📅 2022-03-17 - Easy dylib injection for jailbroken 64-bit iOS 11.0 - 11.1.2. Compatible with Electra and LiberiOS jailbreaks.
...
* [Keychain Dumper](https://github.com/ptoomey3/Keychain-Dumper) ⭐ 1,425 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15 - A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken.
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,307 | 🐛 56 | 🌐 Python | 📅 2026-09-26 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-26 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 22,047 | 🐛 1,965 | 🌐 Meson | 📅 2026-09-25 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,407 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,229 | 🐛 420 | 🌐 Java | 📅 2026-09-26 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,093 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Runtime Mobile Security (RMS), powered by FRIDA, is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,023 | 🐛 202 | 🌐 C | 📅 2026-09-25 - Cross-platform instrumentation and introspection library written in C.
...
* [iOS CheatSheet](https://github.com/randorisec/MobileHackingCheatSheet/blob/master/LEGACY.md#ios-cheatsheet) ⭐ 1,696 | 🐛 2 | 📅 2026-03-19
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,207 | 🐛 243 | 🌐 Python | 📅 2026-09-20
...
* [theos](https://github.com/theos/theos) ⭐ 4,921 | 🐛 72 | 🌐 Makefile | 📅 2026-09-18 - A cross-platform suite of tools for building and deploying software for iOS and other platforms.
