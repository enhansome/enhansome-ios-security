...
[<img src="https://upload.wikimedia.org/wikipedia/commons/5/56/IOS_15_logo.png" align="right" width="70" alt="iOS 15">](https://github.com/Cy-clon3/awesome-ios-security/) ⭐ 671 | 🐛 5 | 📅 2024-01-05
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 75,787 | 🐛 1,962 | 🌐 Java | 📅 2026-09-14 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,796 | 🐛 824 | 🌐 C | 📅 2026-09-14 - UNIX-like reverse engineering framework and command-line toolset.
...
* [iOS App Signer](https://github.com/DanTheMan827/ios-app-signer) ⭐ 6,319 | 🐛 124 | 🌐 Objective-C | 📅 2025-09-01 - An app for macOS that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,501 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Yet another frida based App decryptor. Requires jailbroken iOS device and frida.re.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,263 | 🐛 63 | 🌐 Python | 📅 2026-09-14 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 964 | 🐛 4 | 🌐 C++ | 📅 2026-09-14 - A Mach-O viewer for Windows, Linux and macOS.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,931 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,386 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,098 | 🐛 110 | 🌐 Python | 📅 2026-09-13 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,209 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-13 - Radare2 and Frida better together.
* [Grapefruit](https://github.com/ChiChou/grapefruit) ⭐ 1,387 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-11 - Runtime Application Instruments for iOS.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,019 | 🐛 208 | 🌐 C | 📅 2026-09-09 - Cross-platform instrumentation and introspection library written in C.
...
* [r2ghidra](https://github.com/radareorg/r2ghidra) ⭐ 546 | 🐛 7 | 🌐 C++ | 📅 2026-09-12 - An integration of the Ghidra decompiler for radare2.
...
* [iOS CheatSheet](https://github.com/randorisec/MobileHackingCheatSheet/blob/master/LEGACY.md#ios-cheatsheet) ⭐ 1,688 | 🐛 2 | 📅 2026-03-19
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,182 | 🐛 237 | 🌐 Python | 📅 2026-09-14
