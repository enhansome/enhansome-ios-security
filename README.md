...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,402 | 🐛 1,964 | 🌐 Java | 📅 2026-09-21 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,854 | 🐛 822 | 🌐 C | 📅 2026-09-22 - UNIX-like reverse engineering framework and command-line toolset.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,295 | 🐛 56 | 🌐 Python | 📅 2026-09-22 - An iOS Logs, Events, And Plist Parser.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,998 | 🐛 1,965 | 🌐 Meson | 📅 2026-09-22 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,107 | 🐛 114 | 🌐 Python | 📅 2026-09-13 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,225 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-21 - Radare2 and Frida better together.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,020 | 🐛 209 | 🌐 C | 📅 2026-09-22 - Cross-platform instrumentation and introspection library written in C.
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,195 | 🐛 240 | 🌐 Python | 📅 2026-09-20
