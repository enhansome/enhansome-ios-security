...
[<img src="https://upload.wikimedia.org/wikipedia/commons/5/56/IOS_15_logo.png" align="right" width="70" alt="iOS 15">](https://github.com/Cy-clon3/awesome-ios-security/) ⭐ 669 | 🐛 5 | 📅 2024-01-05
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,613 | 🐛 1,944 | 🌐 Java | 📅 2026-09-08 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,762 | 🐛 819 | 🌐 C | 📅 2026-09-08 - UNIX-like reverse engineering framework and command-line toolset.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,188 | 🐛 61 | 🌐 Python | 📅 2026-09-08 - An iOS Logs, Events, And Plist Parser.
* [XMachOViewer](https://github.com/horsicq/XMachOViewer) ⭐ 961 | 🐛 4 | 🌐 C++ | 📅 2026-09-08 - A Mach-O viewer for Windows, Linux and macOS.
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,373 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
* [Qiling](https://github.com/qilingframework/qiling) ⭐ 6,091 | 🐛 109 | 🌐 Python | 📅 2026-09-07 - An advanced binary emulation framework.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,191 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [Grapefruit](https://github.com/ChiChou/grapefruit) ⭐ 1,382 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-11 - Runtime Application Instruments for iOS.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,017 | 🐛 207 | 🌐 C | 📅 2026-09-03 - Cross-platform instrumentation and introspection library written in C.
...
* [OWASP UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,164 | 🐛 239 | 🌐 Python | 📅 2026-09-08
